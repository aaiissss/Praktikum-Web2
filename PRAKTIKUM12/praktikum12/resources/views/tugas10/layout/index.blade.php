        ...
        <div class="row">
          <div class="col-sm-5">
            ...
            <p class="banner_text">Adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
              Ut enim</p>
            <div class="contact_bt"><a href="{{ url('contact') }}">CONTACT US<span class="contact_padding"><img
                    src="{{ asset('front/images/contact-icon.png') }}"></span></a></div>
          </div>
          <div class="col-sm-2">
      ...
      <div class="team_section_2 layout_padding">
        <div class="container">
          <div class="images_main_1">
            <div class="row">
              <div class="col-sm-5">
                <div class="image_4"><img src="{{ asset('front/images/img-4.pn') }}g"></div>
  ...
  <div class="footer_section layout_padding">
    <div class="container">
      <div class="footer_main">
        ...
        <div class="footer_left">
          <div class="location_text"><a href="#"><img src="{{ asset('front/images/map-icon.png') }}"><span
                class="padding_left_15">Locations</span></a></div>
        </div>
        <div class="footer_left">
          <div class="location_text"><a href="#"><img src="{{ asset('front/images/call-icon.png') }}"><span class="padding_left_15">+71
